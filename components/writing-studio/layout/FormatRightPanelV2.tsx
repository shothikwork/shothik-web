...
export function FormatRightPanelV2({ className }: FormatRightPanelV2Props) {
  ...
  return (
    <aside className={cn(
      "w-[360px] border-l border-zinc-200 dark:border-zinc-800 flex flex-col bg-white dark:bg-brand-surface",
      className
    )}>
      {/* Header */}
          ...
          {activeTab === 'metadata' && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="aspect-[2/3] bg-zinc-100 dark:bg-zinc-800 rounded-lg border-2 border-dashed border-zinc-300 dark:border-zinc-700 flex flex-col items-center justify-center cursor-pointer hover:border-brand transition-colors">
                  <Upload className="w-8 h-8 text-zinc-400 mb-2" />
                  <span className="text-xs text-zinc-500">Drop cover image here</span>
                  <span className="text-[10px] text-zinc-400 mt-1">or click to browse</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full mt-1 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm focus:ring-1 focus:ring-brand focus:border-brand"
                  />
                </div>

                <div>
                  <label className="text-xs text-zinc-600 dark:text-zinc-400">Subtitle</label>
                  <input 
                    type="text" 
                    value={metadata.subtitle}
                    onChange={(e) => updateMetadata('subtitle', e.target.value)}
                    className="w-full mt-1 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm focus:ring-1 focus:ring-brand"
                  />
                </div>

                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-zinc-600 dark:text-zinc-400">Series</label>
                    <input 
                      type="text" 
                      value={metadata.series}
                      onChange={(e) => updateMetadata('series', e.target.value)}
                      className="w-full mt-1 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm"
                    />
                  </div>
                  <div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-zinc-600 dark:text-zinc-400">Author Name *</label>
                  <input 
                    type="text" 
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label className="text-xs text-zinc-600 dark:text-zinc-400">Book Description *</label>
                  <textarea 
                    rows={4}
                    value={metadata.description}
                    onChange={(e) => updateMetadata('description', e.target.value)}
                    className="w-full mt-1 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm resize-none focus:ring-1 focus:ring-brand"
                  />
                  <div className="flex justify-between mt-1">
                    <span className="text-[10px] text-zinc-400">Appears on retailer pages</span>
                    <span className="text-[10px] text-zinc-400">{metadata.description.length}/4000</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-zinc-600 dark:text-zinc-400">Genre *</label>
                    <select 
                  ...
                  <div>
                    <label className="text-xs text-zinc-600 dark:text-zinc-400">Age Rating</label>
                    <select 
                ...
                <div>
                  <label className="text-xs text-zinc-600 dark:text-zinc-400">Keywords (comma separated)</label>
                  <input 
                    type="text" 
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs text-zinc-600 dark:text-zinc-400">Publisher</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="text-xs text-zinc-600 dark:text-zinc-400">Publication Date</label>
                    <input 
                      type="date" 
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full mt-1 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm font-mono"
