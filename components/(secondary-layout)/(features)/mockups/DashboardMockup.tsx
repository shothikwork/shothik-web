...
export default function DashboardMockup({
  ...
  return (
    <div
      className={`mockup-container relative h-[240px] w-full overflow-hidden rounded-lg border border-white/10 bg-[rgba(15,20,35,0.8)] transition-all duration-300 sm:h-[280px] md:h-[350px] lg:h-[450px] ${className || ""}`}
      style={{
