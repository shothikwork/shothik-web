...
const ShareAiDetectorModal = ({
  ...
  const handlePrivateShare = async () => {
    ...
    if (!historyId) {
      showSnackbar("History ID is required", "error");
      return;
    }
            ...
            <div className="px-3 pt-4">
              <TabsContent value="0" className="mt-0 space-y-4">
                <p className="text-muted-foreground text-sm">
                  Share this AI Detection Report privately by sending an email
                  invitation
                </p>
              ...
              <TabsContent value="1" className="mt-0 space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    Anyone with this link can view your AI Detection Report.
                    You can customize access settings below.
                  </AlertDescription>
                </Alert>
...
export default ShareAiDetectorModal;
