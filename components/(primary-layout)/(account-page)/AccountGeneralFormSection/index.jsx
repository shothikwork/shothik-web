              ...
              <div className="flex flex-col items-start gap-6 md:flex-row">
                <div className="flex w-full items-center justify-between gap-6 md:w-auto">
                  <div className="relative h-24 w-24 shrink-0">
                    <Avatar className={cn("size-full border-4")}>
                    ...
                    {user?.is_verified && (
                      <div className="bg-primary text-primary-foreground absolute right-0.5 bottom-0.5 rounded-full p-1">
      ...
      <Card>
        <CardHeader className="border-b">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">{t("account.languagePreference")}</h2>
          </div>
        </CardHeader>
        <CardContent className="p-6">
          ...
          <div className="flex gap-3">
            <Button
              ...
              data-testid="lang-en"
            >
              <span className="mr-2 font-bold">EN</span>
              English
            </Button>
            <Button
              ...
              data-testid="lang-bn"
            >
              <span className="mr-2 font-bold">বাং</span>
              বাংলা
            </Button>
          </div>
        </CardContent>
