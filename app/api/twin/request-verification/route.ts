...
export async function POST(req: NextRequest) {
  ...
  const abilityErr = checkAbility(auth, "requestVerification", "Twin");
  ...
  try {
    ...
    await convex.mutation(twinApi.twin.requestVerification, { twinId });
    ...
    return NextResponse.json({ success: true, twinId, message: "Verification requested. You can now verify your twin." });
  } catch (err: unknown) {
